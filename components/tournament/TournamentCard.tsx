      ...
      <CardContent className="p-4 sm:p-5 pt-0 space-y-3 text-xs">
        ...
        {isCompleted ? (
          <div className="rounded-2xl bg-gradient-to-r from-amber-500/10 via-emerald-500/10 to-amber-500/10 border border-amber-300/60 p-3 space-y-2 shadow-xs">
            ...
            {/* Runner-Up Row */}
            {runnerUp && (
              <div className="flex items-center justify-between gap-2 bg-white/70 p-2 rounded-xl border border-slate-200">
                <div className="flex items-center gap-2 min-w-0">
                  <div className="h-6 w-6 rounded-lg bg-slate-100 border border-slate-300 flex items-center justify-center shrink-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-bold text-xs text-slate-800 truncate">{runnerUp.username}</p>
                  </div>
                </div>
                <Badge variant="outline" className="text-[9px] font-bold border-slate-300 bg-slate-50 text-slate-700 shrink-0">
                  2nd
                </Badge>
              </div>
            )}
